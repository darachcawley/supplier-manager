...
//        ResponseEntity<Order> orderResponse = restTemplate.getForEntity("/restock/books/order/1", Order.class);
...
//
//        ResponseEntity<List<Book>> booksResponse = restTemplate.exchange("/restock/books",
